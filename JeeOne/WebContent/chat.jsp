...
<link href="./assets/css/styleschat.css" rel="stylesheet">
</head>
	...
	<div class="container text-center">
		...
		<div class="row">
			<div class="text-center col-md-6 col-md-offset-3 chat-panel">
				...
				<textarea type="text" data-author="<%=author %>" id="message"
					class="form-control" name="message" placeholder="..."></textarea>
				<br>
				<button class="btn btn-primary btn-block btn-lg" style="background-color:#fab000;" id="submit"
