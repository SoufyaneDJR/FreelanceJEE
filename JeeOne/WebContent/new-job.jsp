                                    ...
                                    <nav class="navbar navbar-default myNavBar">
                                        <div class="container">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                                        <div class="row">
                                                            <div class="col-md-3 col-xs-3 col-sm-3">
                                                                <a style="padding-top:0px;" class="navbar-brand navBrandText text-uppercase font-weight-bold" href="index.html"><img src="" alt="LOGO" /></a>
                                            ...
                                            <ul class="nav navbar-nav navbar-right navBar">
                                                    ...
                                                    <li class="nav-item"><a href="#section3" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">Work</a></li>
                                                    
                                                    
                                                    <li class="nav-item"><a href="#section6" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">Contact</a></li>

                                                    <li class="nav-item"><a href="register.html" class="nav-link text-uppercase font-weight-bold js-scroll-trigger">Sign up</a></li>
  ...
  <form action="joblist?do=insert" method="POST">
    <div class="row">
      ...
      <div class="input-group input-group-icon">
        <input type="text" placeholder="write a headline for your project" name="headline" />
        <div class="input-icon"><i class="fa fa-files-o"></i></div>
      </div>
      <h4>Describe your job</h4>
      <h6>This is how talent figures out what you need and why you’re great to work with!</h6>
      <div class="input-group input-group-icon">
        <textarea name="jobdescription" rows="2" cols="25" placeholder="Already have a job description? Paste it here!"></textarea>
        <div class="input-icon"><i class="fa fa-wpforms"></i></div>
      </div>
        ...
        <h4>Category</h4>
          ...
          <div class="col-third">
            <select name="category" id="selectCategory">
                <option disabled value selected>Which category your work belong</option>
                ...
                <option value="6">Web, Mobile & Software Devselected</option>
    ...
    <div class="row">
      <h1>Scope</h1>
       <div class="col-half">
        ...
        <h4>Size</h4>
          ...
          <div class="col-third">
            <select name="size">
            	<option disabled value selected>Select size of your project</option>
      ...
      <div class="col-half">
        ...
        <div class="input-group">
           <select name="lenght">
                <option disabled value selected>How long will your work take ?</option>
...
filtered = data.filter(({category_id}) => category_id === value);
$(document).ready(function() {
    var skillsSelect="";
    jQuery.each(filtered, function(i, val) {
        skillsSelect +="<div><input type='checkbox' id ="+val.skill_name+" name='skill_id' value="+val.skill_id+"><label for=" + val.skill_name+">"+val.skill_name+"</label></div>";
    });
